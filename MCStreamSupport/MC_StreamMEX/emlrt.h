/*
 * @(#)emlrt.h    generated by: makeheader 5.1.5  Fri Jul 20 17:38:09 2012
 *
 ...
 */
#define EMLRT_VERSION_R2012B 0x2012B
#define EMLRT_VERSION_INFO  EMLRT_VERSION_R2012B
 ...
 */
EXTERN_C boolean_T
emlrtFirstTimeR2012b(emlrtCTX aTLS);
 ...
 */
EXTERN_C const mxArray *
emlrtProtectR2012b(const mxArray *pa, int /*aInputIndex*/, bool /*aByRef*/, int reservedNumEl);
 ...
 */
EXTERN_C void
emlrtLicenseCheckR2012b(emlrtCTX aTLS, const char *aFeatureKey, const int b);
 ...
 */
EXTERN_C void
emlrtClearAllocCountR2012b(emlrtCTX aTLS, boolean_T bM, uint32_T iL, const char* ctDTO);
 ...
 */
EXTERN_C void
emlrtCheckAllocCount(emlrtCTX aTLS);
 ...
 */
EXTERN_C int32_T 
emlrtBoundsCheckR2012b(int32_T indexValue, emlrtBCInfo *aInfo, emlrtCTX aTLS);
 ...
 */
EXTERN_C int32_T 
emlrtDynamicBoundsCheckR2012b(int32_T indexValue, int32_T loBound, int32_T hiBound, emlrtBCInfo *aInfo, emlrtCTX aTLS);
 ...
 */
EXTERN_C size_t emlrtSizeMulR2012b(size_t s1, size_t s2, const emlrtRTEInfo *aInfo, emlrtCTX aTLS);
 ...
 */
EXTERN_C const mxArray *
emlrtCreateEnumR2012b(emlrtCTX aTLS, const char *name, const mxArray *data);
 ...
 */
EXTERN_C void emlrtMatlabDataToCFormat(const mxArray* inputMx, const mxArray* cformatMx);


/*
 * MATLAB INTERNAL USE ONLY :: Convert C data format to MATLAB data format
 */
EXTERN_C void emlrtMatlabDataFromCFormat(const mxArray* outputMx, const mxArray* cformatMx);
 ...
 */
EXTERN_C void
emlrtDisplayR2012b(const mxArray *pa, const char *name, emlrtMCInfo* aLoc, emlrtCTX aTLS);
 ...
 */
EXTERN_C real_T 
emlrtIntegerCheckR2012b(real_T d, emlrtDCInfo *aInfo, emlrtCTX aTLS);
 ...
 */
EXTERN_C real_T 
emlrtNotNanCheckR2012b(real_T d, emlrtDCInfo *aInfo, emlrtCTX aTLS);
 ...
 */
EXTERN_C real_T 
emlrtNonNegativeCheckR2012b(real_T d, emlrtDCInfo *aInfo, emlrtCTX aTLS);
 ...
 */
EXTERN_C const mxArray *
emlrtCallMATLABR2012b(emlrtCTX aTLS, int32_T nlhs, const mxArray **plhs, int32_T nrhs, const mxArray **prhs, const char *cmd, boolean_T tmp, emlrtMCInfo* aLoc);


/*
 * MATLAB INTERNAL USE ONLY :: Maintain heap memory check information upon entering a mex function.
 */
EXTERN_C void emlrtHeapMemCheckInitialize(emlrtCTX aTLS, int aMaxHeapSize);


/*
 * MATLAB INTERNAL USE ONLY :: Maintain heap memory check information upon leaving a mex function.
 */
EXTERN_C void emlrtHeapMemCheckTerminate();


/*
 * MATLAB INTERNAL USE ONLY :: Register the mex function to be unloaded.
 */
EXTERN_C void emlrtHeapMemCheckPrepareUnload(emlrtCTX aTLS);
 ...
 */
EXTERN_C void emlrtHeapMemCheckUnloadMex(emlrtCTX aTLS);


/*
 * MATLAB INTERNAL USE ONLY :: malloc with memory integrity check
 */
EXTERN_C void* emlrtMalloc(emlrtCTX aTLS, size_t aSize);


/*
 * MATLAB INTERNAL USE ONLY :: calloc with memory integrity check
 */
EXTERN_C void* emlrtCalloc(emlrtCTX aTLS, size_t aNum, size_t aSize);
 ...
 */
EXTERN_C void* emlrtMallocMex(size_t aSize);


/*
 * MATLAB INTERNAL USE ONLY :: calloc for MEX
 */
EXTERN_C void* emlrtCallocMex(size_t aNum, size_t aSize);


/*
 * MATLAB INTERNAL USE ONLY :: free for MEX
 */
EXTERN_C void emlrtFreeMex(void *aPtr);


/*
 * MATLAB INTERNAL USE ONLY :: Enter a new function within a MEX call.
 */
EXTERN_C void emlrtHeapReferenceStackEnterFcnR2012b(emlrtCTX aTLS);
 ...
 */
EXTERN_C void emlrtHeapReferenceStackLeaveScope(emlrtCTX aTLS, int aAllocCount);


/*
 * MATLAB INTERNAL USE ONLY :: Leave a function within a MEX call.
 */
EXTERN_C void emlrtHeapReferenceStackLeaveFcnR2012b(emlrtCTX aTLS);
 ...
 */
EXTERN_C void emlrtPushHeapReferenceStackR2012b(emlrtCTX aTLS, void *aHeapReference, EmlrtHeapReferenceFreeFcn aFreeFcn);
 ...
 */
EXTERN_C void 
emlrtEnterParallelRegion(emlrtCTX aTLS, boolean_T aInParallelRegion);
 ...
 */
EXTERN_C void 
emlrtExitParallelRegion(emlrtCTX aTLS, boolean_T aInParallelRegion);
 ...
 */
EXTERN_C bool 
emlrtIsMATLABThread(emlrtCTX aTLS);


/*
 * MATLAB INTERNAL USE ONLY :: Record the occurance of a parallel warning.
 */
EXTERN_C bool
emlrtSetWarningFlag(emlrtCTX aTLS);


/*
 * MATLAB INTERNAL USE ONLY :: Report a parallel runtime error
 */
EXTERN_C void emlrtReportParallelRunTimeError(emlrtCTX aTLS);


/*
 * MATLAB INTERNAL USE ONLY :: Ensure active thread is MATLAB
 */
EXTERN_C void emlrtAssertMATLABThread(emlrtCTX aTLS, emlrtMCInfo* aLoc);
 ...
 */
EXTERN_C void 
emlrtDivisionByZeroErrorR2012b(const emlrtRTEInfo *aInfo, emlrtCTX aTLS);
 ...
 */
EXTERN_C void 
emlrtIntegerOverflowErrorR2012b(const emlrtRTEInfo *aInfo, emlrtCTX aTLS);


/*
 * MATLAB INTERNAL USE ONLY :: Raise C heap allocation failure
 */
EXTERN_C void emlrtHeapAllocationErrorR2012b(const emlrtRTEInfo *aInfo, emlrtCTX aTLS);


/*
 * MATLAB INTERNAL USE ONLY :: Error with given message ID and args.
 */
EXTERN_C void emlrtErrorWithMessageIdR2012b(emlrtCTX aTLS, const emlrtRTEInfo *aInfo, const char *aMsgID, int aArgCount, ...);
 ...
 */
EXTERN_C mxArray* emlrtLocationLoggingPullLog(const char* const MexFileName, bool pullCompReportFromMexFunction);
 ...
 */
EXTERN_C void emlrtEnterRtStackR2012b(emlrtCTX aTLS);


/*
 * MATLAB INTERNAL USE ONLY :: Terminate a runtime stack
 */
EXTERN_C void emlrtLeaveRtStackR2012b(emlrtCTX aTLS);


/*
 * MATLAB INTERNAL USE ONLY :: Push to runtime stack
 */
EXTERN_C void emlrtPushRtStackR2012b(const struct emlrtRSInfo *aRSInfo, emlrtCTX aTLS);


/*
 * MATLAB INTERNAL USE ONLY :: Pop from runtime stack
 */
EXTERN_C void emlrtPopRtStackR2012b(const struct emlrtRSInfo *aRSInfo, emlrtCTX aTLS);
 ...
 */
EXTERN_C const volatile char* 
emlrtGetBreakCheckFlagAddressR2012b();
 ...
 */
EXTERN_C void
emlrtBreakCheckR2012b(emlrtCTX aTLS);
 ...
 */
EXTERN_C void 
emlrtSizeEqCheck1DR2012b(int32_T dim1, int32_T dim2, emlrtECInfo *aInfo, emlrtCTX aTLS);
 ...
 */
EXTERN_C void 
emlrtSizeEqCheckNDR2012b(const int32_T* dims1, const int32_T* dims2, emlrtECInfo *aInfo, emlrtCTX aTLS);
 ...
 */
EXTERN_C void 
emlrtDimSizeEqCheckR2012b(int32_T dim1, int32_T dim2, emlrtECInfo *aInfo, emlrtCTX aTLS);
 ...
 */
EXTERN_C void 
emlrtDimSizeGeqCheckR2012b(int32_T dim1, int32_T dim2, emlrtECInfo *aInfo, emlrtCTX aTLS);
 ...
 */
EXTERN_C void 
emlrtSubAssignSizeCheckR2012b(const int32_T* dims1, int32_T nDims1, const int32_T* dims2, int32_T nDims2, emlrtECInfo *aInfo, emlrtCTX aTLS);
 ...
 * matrix (not a vector).
 */
EXTERN_C void emlrtMatrixMatrixIndexCheckR2012b(const int32_T* dims1, int32_T nDims1, const int32_T* dims2, int32_T nDims2, emlrtECInfo *aInfo, emlrtCTX aTLS);
 ...
 * matrix (not a vector).
 */
EXTERN_C void emlrtVectorVectorIndexCheckR2012b(int32_T sizeL_0, int32_T sizeL_1, int32_T sizeR_0, int32_T sizeR_1, emlrtECInfo *aInfo, emlrtCTX aTLS);


/*
 * MATLAB INTERNAL USE ONLY :: Allocate thread-local storage.
 */
EXTERN_C emlrtCTX emlrtAllocTLS(emlrtCTX aMaster, int32_T aTeamTID);
 ...
 */
EXTERN_C int32_T 
emlrtAllocRegionTLSs(emlrtCTX aTLS, boolean_T aInParallelRegion, int32_T aMaxThreads, int32_T aNumThreads);


/*
 * MATLAB INTERNAL USE ONLY :: Allocate the root thread-local storage.
 */
EXTERN_C void emlrtCreateRootTLS(emlrtCTX *aRootTLS, struct emlrtContext *aContext, EmlrtLockerFunction aLockerFunction, int32_T aNumProcs);


/*
 * MATLAB INTERNAL USE ONLY :: Deallocate the root thread-local storage.
 */
EXTERN_C void emlrtDestroyRootTLS(emlrtCTX *aRootTLS);
 ...
 */
EXTERN_C void 
emlrtCheckBuiltInR2012b(emlrtCTX aTLS,
 ...
 */
EXTERN_C void 
emlrtCheckVsBuiltInR2012b(emlrtCTX aTLS,
                             const struct emlrtMsgIdentifier *aMsgId, const mxArray *pa, 
                             const char *className, boolean_T complex, uint32_T nDims, const void *pDims, 
 ...
 */
EXTERN_C void 
emlrtCheckFiR2012b(emlrtCTX aTLS,
 ...
 */
EXTERN_C void 
emlrtCheckVsFiR2012b(emlrtCTX aTLS,
                        const struct emlrtMsgIdentifier *aMsgId, const mxArray *aFi, boolean_T aComplex, 
                        uint32_T aNDims, const void *aVDims, 
 ...
 */
EXTERN_C void 
emlrtCheckStructR2012b(emlrtCTX aTLS, const emlrtMsgIdentifier *aMsgId, const mxArray *s, int32_T nFields, const char **fldNames,
 ...
 */
EXTERN_C void
emlrtCheckVsStructR2012b(emlrtCTX aTLS, const struct emlrtMsgIdentifier *aMsgId, const mxArray *s, 
 ...
 */
EXTERN_C void 
emlrtCheckEnumR2012b(emlrtCTX aTLS, const char *enumName, int32_T nEnumElements, const char **enumNames, const int32_T *enumValues);
